...
public class ArmourCreation implements ItemCreationStrategy
{
    ...
    {
        return new Armour(tokens[0], Integer.parseInt(tokens[2]), 
    ...
    public Item fromExisting(final Item original)
    {
        ...
        return new Armour(theOriginal.getName(), theOriginal.getDurability(),
        theOriginal.getDefense(), theOriginal.getMaterial(), theOriginal.getModifier(), 
